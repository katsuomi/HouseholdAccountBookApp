...
import {submitExpend,searchExpendsCategoli,readYourGraph,readExpends} from "../actions";
...
const mapDispatchToProps = ({submitExpend,searchExpendsCategoli,readYourGraph,readExpends })
